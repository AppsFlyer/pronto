...
public class Generator implements Opcodes {
    ...
    private static void printClassFrame(byte[] bytecode) {
        ClassReader reader = new ClassReader(bytecode);
        reader.accept(new TraceClassVisitor(new PrintWriter(System.out)), 1);
    }

    public static void main(String[] args) throws Exception {
        byte[] bytes1 = dump();
        byte[] bytes2 = OriginalGen.dump();

        boolean equals = Arrays.equals(bytes1, bytes2);
        System.out.println("equals: " + equals);
    }

    private static Descriptors.Descriptor extractTypeDescriptor(Class<?> mainCls) throws Exception {
        Method getDescriptor = mainCls.getDeclaredMethod("getDescriptor");
        return (Descriptors.Descriptor) getDescriptor.invoke(null);
    }

    private static List<Descriptors.FieldDescriptor> getMessageFields(Descriptors.Descriptor descriptor) {
    ...
    private static Class<?> getFieldJavaType(Class<?> mainCls, Descriptors.FieldDescriptor field) throws Exception {
        Field javaField = mainCls.getDeclaredField(field.getName() + "_");
        if (field.isRepeated()) {
    ...
    private static Class<?> getBuilderType(Class<?> mainCls) throws Exception {
        return Class.forName(mainCls.getName() + "$Builder");
    }

    private static String getTypePath(Class<?> type) {
    ...
    public static class TypeDesc {
        ...
        public TypeDesc(String name, String outerName, String innerName) {
            this.name = name;
            this.outerName = outerName;
            this.innerName = innerName;
        }

        static TypeDesc fromType(Class<?> mainCls) {
            return new TypeDesc(getTypePath(mainCls), getTypePath(mainCls.getDeclaringClass()), mainCls.getSimpleName());
        }
    }

    private static void generateConstantPoolInnerClassRefs(Class<?> mainCls, Descriptors.Descriptor descriptor, ClassWriter classWriter) throws Exception {
        TypeDesc desc = TypeDesc.fromType(mainCls);
        classWriter.visitInnerClass(desc.name, desc.outerName, desc.innerName, ACC_PUBLIC | ACC_FINAL | ACC_STATIC);

        Class<?> builderCls = getBuilderType(mainCls);
        desc = TypeDesc.fromType(builderCls);
        classWriter.visitInnerClass(desc.name, desc.outerName, desc.innerName, ACC_PUBLIC | ACC_FINAL | ACC_STATIC);

        List<Descriptors.FieldDescriptor> msgFields = getMessageFields(descriptor);
        for (Descriptors.FieldDescriptor field : msgFields) {
            Class<?> fieldCls = getFieldJavaType(mainCls, field);
            desc = TypeDesc.fromType(fieldCls);
            classWriter.visitInnerClass(desc.name, desc.outerName, desc.innerName, ACC_PUBLIC | ACC_FINAL | ACC_STATIC);
        }
    }

    public static byte[] dump() throws Exception {
        Class<?> mainProtoCls = People.Person.class;
        String pkg = "protogen";

        Descriptors.Descriptor descriptor = extractTypeDescriptor(mainProtoCls);
        ClassWriter classWriter = new ClassWriter(0);

        generateClass(mainProtoCls, pkg, classWriter);
        generateConstantPoolInnerClassRefs(mainProtoCls, descriptor, classWriter);
        // add static keyword fields.
        generateStaticKeywords(mainProtoCls, classWriter, descriptor);

        // add private field to store the actual proto object
        generatePrivateProtoField(mainProtoCls, classWriter);

        generateMapToProto(mainProtoCls, classWriter);
        generateCtorFromMap(mainProtoCls, classWriter);
        generateCtorFromProto(mainProtoCls, classWriter);
        generateGetProto(mainProtoCls, classWriter);
        generateContainsKey(mainProtoCls, classWriter);
        generateEntryAt(mainProtoCls, classWriter);
        generateAssoc(mainProtoCls, classWriter);
        generateAssocEx(mainProtoCls, classWriter);
        generateWithout(mainProtoCls, classWriter);
        generateValAt(mainProtoCls, classWriter);
        generateValAtWithDefault(mainProtoCls, classWriter);
        generateCount(mainProtoCls, classWriter);
        generateEmpty(mainProtoCls, classWriter);
        generateSeq(mainProtoCls, classWriter);
        generateIterator(mainProtoCls, classWriter);
        generateSyntheticAssocBridge(mainProtoCls, classWriter);
        generateStaticInit(mainProtoCls, classWriter);
    ...
    private static void generateClass(Class<?> mainProtoCls, String pkg, ClassWriter classWriter) {
        String clsMapName = mainProtoCls.getSimpleName() + "ProtoMap";

        classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, pkg + "/" + clsMapName,
                null,
    ...
    private static void generateStaticKeywords(Class<?> mainProtoCls, ClassWriter classWriter, Descriptors.Descriptor descriptor) {
        for (Descriptors.FieldDescriptor field : descriptor.getFields()) {
            String fieldName = "_" + field.getName().toUpperCase();
    ...
    private static void generatePrivateProtoField(Class<?> mainProtoCls, ClassWriter classWriter) {
        String protoClsTypeDesc = "L" + mainProtoCls.getName().replaceAll("\\.", "/") + ";";
        FieldVisitor fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL,
                mainProtoCls.getSimpleName().toLowerCase(),
                protoClsTypeDesc, null, null);
        fieldVisitor.visitEnd();
    }

    private static void generateMapToProto(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC,
                "mapToProto",
                "(Lclojure/lang/IPersistentMap;)Lprotogen/generated/People$Person;",
                null,
                null);
    ...
    private static void generateCtorFromMap(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lclojure/lang/IPersistentMap;)V", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateCtorFromProto(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lprotogen/generated/People$Person;)V", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateGetProto(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getProto", "()Lprotogen/generated/People$Person;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateContainsKey(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "containsKey", "(Ljava/lang/Object;)Z", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateEntryAt(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "entryAt", "(Ljava/lang/Object;)Lclojure/lang/IMapEntry;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateAssoc(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "assoc", "(Ljava/lang/Object;Ljava/lang/Object;)Lclojure/lang/IPersistentMap;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateAssocEx(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "assocEx", "(Ljava/lang/Object;Ljava/lang/Object;)Lclojure/lang/IPersistentMap;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateWithout(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "without", "(Ljava/lang/Object;)Lclojure/lang/IPersistentMap;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateValAt(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "valAt", "(Ljava/lang/Object;)Ljava/lang/Object;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateValAtWithDefault(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "valAt", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    static private void generateCount(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "count", "()I", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateEmpty(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "empty", "()Lclojure/lang/IPersistentCollection;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateSeq(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "seq", "()Lclojure/lang/ISeq;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateIterator(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "iterator", "()Ljava/util/Iterator;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
    ...
    private static void generateStaticInit(Class<?> mainProtoCls, ClassWriter classWriter) {
    ...
    private static void generateSyntheticAssocBridge(Class<?> mainProtoCls, ClassWriter classWriter) {
        MethodVisitor methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_BRIDGE | ACC_SYNTHETIC, "assoc", "(Ljava/lang/Object;Ljava/lang/Object;)Lclojure/lang/Associative;", null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
